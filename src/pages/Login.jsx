                    ...
                    <div className="grid grid-cols-3 gap-3">
                        {oauthProviders.map((provider, i) => (
                            <motion.button
                                ...
                                whileTap={{ scale: 0.95 }}
                                type="button"
                                className={`flex flex-col items-center gap-1.5 py-3 rounded-lg border border-white/10 bg-black/20 text-muted-foreground hover:text-white hover:border-white/20 transition-all duration-200`}
                            >
