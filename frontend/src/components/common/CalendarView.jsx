                            ...
                            <div className="flex-1 space-y-1.5 overflow-y-auto pr-1 stylish-scrollbar">
                                {dayEvents.map((ev, idx) => {
                                    if (ev.type === 'milestone') {
                                        return (
                                            <div key={`m-${ev.data._id}-${idx}`} className="text-[10px] bg-purple-500/10 text-purple-600 dark:text-purple-400 px-1.5 py-1 rounded-md border-l-2 border-purple-500 truncate flex items-center gap-1 cursor-default hover:bg-purple-500/20" title={ev.data.name}>
                                    ...
                                    if (ev.type === 'meeting') {
                                        ...
                                        return (
                                            <div key={`meet-${ev.data._id}`} className="text-[10px] bg-blue-500/10 text-blue-600 dark:text-blue-400 px-1.5 py-1 rounded-md border-l-2 border-blue-500 truncate flex items-center gap-1 cursor-default hover:bg-blue-500/20" title={`${ev.data.title} at ${timeStr}`}>
                                    ...
                                    if (ev.type === 'issue') {
                                        return (
                                            <div key={`iss-${ev.data._id}`} className="text-[10px] bg-muted/50 text-foreground px-1.5 py-1 rounded-md border border-border/40 truncate flex items-center gap-1.5 cursor-pointer hover:border-primary/50 hover:bg-background shadow-xs transition-colors" title={ev.data.title}>
